var LIBSSHUU = {
    ...
    rotateObjectAroundArbitraryAxis: function(object, axis, angle) {
        ...
        var rotationMatrix = LIBSSHUU.getRotationMatrix(axis, angle);
    
        // Apply rotation to the object's model matrix
        object.SHUU_MATRIX = LIBSSHUU.multiply(object.SHUU_MATRIX, rotationMatrix);
    },
    ...
    get_projection: function (angle, a, zMin, zMax) {
        ...
        var tan = Math.tan(LIBSSHUU.degToRad(0.5 * angle)),
